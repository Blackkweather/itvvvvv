import { FIRESTICK_CONFIG, getDeviceConfig } from "@/components/device/deviceConfig";
...
export const metadata = generateDeviceMetadata(FIRESTICK_CONFIG);

export default function FirestickPage() {
  const config = FIRESTICK_CONFIG;
